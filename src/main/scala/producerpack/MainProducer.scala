...
//        trend3Vector.foreach(println)
      ...
      val t1 = trend1.getTrend1(spark, 100000)
      println("Generating Trend 2...")
      val t2 = trend2.getTrend2(spark, 100000)
      println("Generating Trend 3...")
      val t3 = trend3.getTrend3(spark, 100000)
      println("Generating Trend 4...")
      val t4 = trend4.getTrend4(spark, 100000)
      println("Generating Trend 5...")
      val t5 = trend5.getTrend5(spark, 100000)
      println("Generating Trend 6...")
      val t6 = trend6.getTrend6(spark, 100000)
      println("Generating Trend 7...")
      val t7 = trend7.getTrend7(spark, 100000)
      println("Generating Trend 8...")
      val t8 = trend8.getTrend8(spark, 100000)
      println("Generating Trend 9...")
      val t9 = ExponentialIncreaseOverTimeTrend.createTrend(100000, 1, 1000,ListBuffer(1,1,2000))
