...
object blackFridayTrend {
  ...
  */
  ...
  def manipulateDateAndPrice(inputTransaction: String, date: String): String = {
    ...
    var resultString = ""
    resultString = splitT(0) + "," + splitT(1) + "," + splitT(2) + "," + splitT(3) + "," + splitT(4) + "," + splitT(5) + "," + splitT(6) + "," +
      splitT(7) + "," + (splitT(8).toDouble*getPercentOff()).toString + "," + date + "," + splitT(10) + "," + splitT(11) + "," + splitT(12) + ","+ splitT(13) + "," + splitT(14) + "," + splitT(15)
    return resultString
  }
  ...
  def getRandomYear(): String ={
    random.nextInt(((2025-2000)+1)+2000).toString
  }
  ...
  def getBlackFridayTrend(spark: SparkSession, returnAmount: Int): Vector[String]={
