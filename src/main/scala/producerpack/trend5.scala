...
object trend5 {
  ...
  //in this case, every tenth transaction will be updated to contain 'Crypto' as payment type and 'United States' as the country
  // We receive a comma separated string, split it by ",", use the array to create a new string, and return.
  def manipulateTransactionTrend5(inputTransaction: String, counter: Int): String = {
